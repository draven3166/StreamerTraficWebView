...
/*import com.erbol.bo.aacdecoder.IcyURLStreamHandler;
import com.erbol.bo.aacdecoder.MultiPlayer;
import com.erbol.bo.aacdecoder.PlayerCallback;*/
...
public class StreamingService extends Service implements PlayerCallback {
	...
	public synchronized void startStreaming(final URI streamURI) throws StreamingException {
        ...
        if(player != null) throw new StreamingException("Streaming no detenido aun");
		if(playerStarted) throw new StreamingException("Streaming ya comenzo");
		playerStarted = true;
